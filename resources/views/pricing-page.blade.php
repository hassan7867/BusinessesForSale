...
@section('content')
    ...
    <div class="no-bottom no-top" id="content">
        ...
        <br>
        <br>
        <section id="section-hero" aria-label="section" class="no-top no-bottom vh-50">
            {{--<div class="v-center">--}}
                {{--<div class="container-">--}}
                    <div class="row align-items-center">
                        ...
                        {{--</div>--}}
                        <div class="col-md-12 xs-hide mt-5">
                            <img src="{{url('')}}/gallery-item-6.jpg" style="width: 100%" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s" alt="">
                            <div class="centered" style="position: absolute">List your business in Portugal
                                Create your business listing today</div>
                        </div>
                    </div>
                {{--</div>--}}
            {{--</div>--}}
